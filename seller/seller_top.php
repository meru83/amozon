        ...
        <div class="left-menu">
            <div>
                <ul class="menu-list">
                    ...
                    <li class="menu-item"><a href=""><span class="menu-item-icon">🔍</span><span class="menu-item-text">検索</span></a></li>
                    ...
                    <li class="menu-item"><a href="p2_insert.php"><span class="menu-item-icon">➕</span><span class="menu-item-text">商品登録</span></a></li>
