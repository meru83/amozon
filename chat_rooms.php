        ...
        <div class="left-menu">
            <div>
                <ul class="menu-list">
                    ...
                    <li class="menu-item"><a href="favoriteProduct.php"><img src="img/meisi.png" class="logo"><span class="menu-item-text">購入履歴</span></a></li>
        ...
        <div class="left-menu">
            <div>
                ...
                <li class="menu-item-logo"><a href=""><img src="img/cart_dake.svg" class="logo"><span class="menu-item-text-logo">Re.ReaD</span></a></li>
                    ...
                    $seller_chat
                    <li class="menu-item"><a href="seller_profile.php"><img src="img/hito.png" class="logo"><span class="menu-item-text">プロフィール</span></a></li>
                    <!--log--->
                </ul>
            </div>
            <div>
